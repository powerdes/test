...
do
        ...
        # Mount data disk to hosts 
        ssh -o 'StrictHostKeyChecking no' root@$HOST "echo ';' | sfdisk /dev/sdc"
        ssh -o 'StrictHostKeyChecking no' root@$HOST "mkfs -t ext4 /dev/sdc1"
        ssh -o 'StrictHostKeyChecking no' root@$HOST "mkdir -p /hadoop/hdfs/data"
        ssh -o 'StrictHostKeyChecking no' root@$HOST "mount /dev/sdc1 /hadoop/hdfs/data"
